...
# import json
# with open("city.json","r", encoding='utf-8') as a:
...
# import re
# a = '13194582.7,4288882.83'
# b = re.match('(\d*\D\d*)\W(\d*\D\d*)',a)
# x = b.group(1)
# y = b.group(2)
# x1 = re.match('\d{3}',x).group()+'.'+re.match('(\d{3})(\d{4})',x).group(2)
# y1 = re.match('\d{2}',y).group()+'.'+re.match('(\d{2})(\d{4})',y).group(2)
# point = x1+', '+y1
# print(x,y)
# print(x1,y1)
# print(point)
...
a = "126.2319,26.6430"
a_list = a.split('x')
# a_deal = float(a_list[0])
print(a_list)
s = [float(i) for i in a_list[0].split(',')]
print(s)
b = "136.2319,36.6430"
# print(list(a))
# a_list = []
